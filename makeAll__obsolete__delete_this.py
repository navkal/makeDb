...
if __name__ == '__main__':
    ...
    status = os.system( 'C:\\Users\Ayee\Anaconda3\python.exe "E:/ayee/Python/makeDb/makeDeviceTable.py" -i "E:/ayee/Python/makeDb/distribution.csv" -c "E:/ayee/Python/makeDb/devices.csv" -s "E:/Share/EA/AHS/devices.csv" -x "E:/Share/EA/AHS/devices.xlsx"' )
