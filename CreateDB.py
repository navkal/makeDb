...
def make_database( bDestroy ):
    ...
    dbCommon.add_interactive_user( cur, 'test', 'test', 'technician', 'Test', True )
    dbCommon.add_interactive_user( cur, 'sorry', 'sorry', 'visitor', 'Sorry', True )
    dbCommon.add_interactive_user( cur, 'change', 'change', 'visitor', 'Change', True )
    dbCommon.add_interactive_user( cur, 'update', 'update', 'visitor', 'Update', True )
